...
> [`apps/mp-server`](https://github.com/jewell-lgtm/monkeypuzzle/blob/main/apps/mp-server). The Helm chart is the supported path for
...
See [`deploy/charts/monkeypuzzle/values.yaml`](https://github.com/jewell-lgtm/monkeypuzzle/blob/main/deploy/charts/monkeypuzzle/values.yaml)
