...
See [contributing.md](/docs/contributing/) for the outside-in testing philosophy.
...
> This PR adds new functionality but I don't see an integration test for the happy path. Could you add one? See [contributing.md](/docs/contributing/) for examples.
